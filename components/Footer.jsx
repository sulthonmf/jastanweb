    ...
    return (
        <div className="pt-12">
            <footer id="footer" className="relative z-50 dark:bg-gray-900 pt-24">
                ...
                <div className="py-16 flex flex-col justify-center items-center bg-blue-700 text-white">
                    <Link href="javascript:void(0)">
                        <a>
                    ...
                    <p className="mt-6 text-xs lg:text-sm leading-none text-white dark:text-gray-50">@ 2021 PT Asuransi Jasa Tania. All Rights Reserved.</p>
                </div>
            </footer>
        </div>
    );
